...
static const i18n_entry_t fr_strings[] = {
    ...
    { "ui.zoom_level",    "Niveau de zoom" },
    { "ui.view_space",    "Vue spatiale" },
    { "ui.view_earth",    "Vue terrestre" },
    { "ui.festival_alert","Alerte festival" },
    ...
    { "depth.cycle",        "Cycle" },
    { "depth.cosmic",       "Cosmique" },
    { "view.space",         "Vue spatiale" },
    { "view.earth",         "Vue terrestre" },
    { "view.tzolkin",       "Vue Tzolkin" },
    { "view.iching",        "Vue Yi King" },
    { "view.calendar",      "Vue calendrier" },
    { "view.deep_time",     "Vue temps profond" },
    ...
    { "content.fun_fact",   "Anecdote" },
    { "content.story",      "Histoire culturelle" },
    { "content.achievement","R\xc3\xa9" "alisation" },
    ...
    { "toast.speed_changed",    "Vitesse modifi\xc3\xa9" "e" },
    { "toast.view_changed",     "Vue modifi\xc3\xa9" "e" },
    { "toast.layer_toggled",    "Couche bascul\xc3\xa9" "e" },
    { "toast.jump_complete",    "Saut termin\xc3\xa9" },
    { "toast.location_set",     "Position d\xc3\xa9" "finie" },
    { "toast.time_paused",      "Temps en pause" },
    ...
    { "welcome.where_born",    "O\xc3\xb9 \xc3\xa9tiez-vous sur Terre ?" },
    { "welcome.skip",          "Passer" },
    { "welcome.continue",      "Continuer" },
    { "welcome.reveal",        "D\xc3\xa9" "couvrez votre identit\xc3\xa9 cosmique" },
    { "welcome.complete",      "Bienvenue dans Time" },
    { "error.no_data",         "Aucune donn\xc3\xa9" "e disponible" },
    { "error.invalid_date",    "Date invalide" },
    { "error.out_of_range",    "Date hors limites" },
...
#define FR_STRING_COUNT \
    ((int)(sizeof(fr_strings) / sizeof(fr_strings[0])))

/* ---- Portuguese (PT) — 111 keys ---- */

static const i18n_entry_t pt_strings[] = {
    { "system.gregorian",    "Gregoriano" },
    ...
    { "ui.zoom_level",    "N\xc3\xadvel de zoom" },
    { "ui.view_space",    "Vista Espacial" },
    { "ui.view_earth",    "Vista Terrestre" },
    { "ui.festival_alert","Alerta de festival" },
    { "ui.retrograde",    "retr\xc3\xb3grado" },
    ...
    { "view.tzolkin",       "Vista Tzolkin" },
    { "view.iching",        "Vista I Ching" },
    { "view.calendar",      "Vista Calend\xc3\xa1rio" },
    { "view.deep_time",     "Vista Tempo Profundo" },
    { "time.paused",        "Pausado" },
    { "time.reversed",      "Invertido" },
    ...
    { "time.jump_to",       "Ir para" },
    { "layer.astronomy",    "Astronomia" },
    { "layer.astrology",    "Astrologia" },
    { "layer.calendar",     "Calend\xc3\xa1rios" },
    { "layer.sacred",       "Sistemas Sagrados" },
    { "layer.earth",        "Terra" },
    { "layer.display",      "Exibi\xc3\xa7\xc3\xa3o" },
    { "content.wisdom",     "Sabedoria" },
    { "content.fun_fact",   "Curiosidade" },
    { "content.story",      "Hist\xc3\xb3ria Cultural" },
    { "content.achievement","Conquista" },
    ...
    { "cal.sign",           "Signo" },
    { "cal.festival",       "Festival" },
    { "toast.speed_changed",    "Velocidade alterada" },
    { "toast.view_changed",     "Vista alterada" },
    { "toast.layer_toggled",    "Camada alternada" },
    { "toast.jump_complete",    "Salto conclu\xc3\xad" "do" },
    { "toast.location_set",     "Localiza\xc3\xa7\xc3\xa3o definida" },
    { "toast.time_paused",      "Tempo pausado" },
    { "a11y.skip_to_content",  "Pular para o conte\xc3\xba" "do" },
    { "a11y.screen_reader",    "Modo leitor de tela" },
    { "a11y.high_contrast",    "Alto contraste" },
    { "a11y.reduced_motion",   "Movimento reduzido" },
    { "welcome.when_born",     "Quando voc\xc3\xaa chegou a este planeta?" },
    { "welcome.where_born",    "Onde na Terra voc\xc3\xaa estava?" },
    { "welcome.skip",          "Pular" },
    { "welcome.continue",      "Continuar" },
    { "welcome.reveal",        "Descubra sua identidade c\xc3\xb3smica" },
    { "welcome.complete",      "Bem-vindo ao Time" },
    { "error.no_data",         "Sem dados dispon\xc3\xadveis" },
    { "error.invalid_date",    "Data inv\xc3\xa1lida" },
    { "error.out_of_range",    "Data fora do intervalo" },
...
#define PT_STRING_COUNT \
    ((int)(sizeof(pt_strings) / sizeof(pt_strings[0])))

/* ---- German (DE) — 111 keys ---- */

static const i18n_entry_t de_strings[] = {
    ...
    { "system.human_design", "Human Design" },
    { "ui.zoom_level",    "Zoomstufe" },
    { "ui.view_space",    "Weltraumansicht" },
    { "ui.view_earth",    "Erdansicht" },
    { "ui.festival_alert","Festalarm" },
    { "ui.retrograde",    "r\xc3\xbckl\xc3\xa4ufig" },
    { "ui.direct",        "direkt" },
    { "ui.day",           "Tag" },
    { "ui.days",          "Tage" },
    { "ui.month",         "Monat" },
    ...
    { "depth.context",      "Kontext" },
    { "depth.cycle",        "Zyklus" },
    { "depth.cosmic",       "Kosmisch" },
    { "view.space",         "Weltraumansicht" },
    { "view.earth",         "Erdansicht" },
    { "view.tzolkin",       "Tzolkin-Ansicht" },
    { "view.iching",        "I Ging-Ansicht" },
    { "view.calendar",      "Kalenderansicht" },
    { "view.deep_time",     "Tiefzeitansicht" },
    ...
    { "time.jump_to",       "Springen zu" },
    { "layer.astronomy",    "Astronomie" },
    { "layer.astrology",    "Astrologie" },
    { "layer.calendar",     "Kalender" },
    { "layer.sacred",       "Heilige Systeme" },
    { "layer.earth",        "Erde" },
    { "layer.display",      "Anzeige" },
    { "content.wisdom",     "Weisheit" },
    { "content.fun_fact",   "Wissenswertes" },
    { "content.story",      "Kulturgeschichte" },
    { "content.achievement","Errungenschaft" },
    ...
    { "cal.sign",           "Zeichen" },
    { "cal.festival",       "Fest" },
    { "toast.speed_changed",    "Geschwindigkeit ge\xc3\xa4ndert" },
    { "toast.view_changed",     "Ansicht ge\xc3\xa4ndert" },
    { "toast.layer_toggled",    "Ebene umgeschaltet" },
    { "toast.jump_complete",    "Sprung abgeschlossen" },
    { "toast.location_set",     "Standort festgelegt" },
    { "toast.time_paused",      "Zeit pausiert" },
    ...
    { "welcome.complete",      "Willkommen bei Time" },
    { "error.no_data",         "Keine Daten verf\xc3\xbcgbar" },
    { "error.invalid_date",    "Ung\xc3\xbcltiges Datum" },
    { "error.out_of_range",    "Datum au\xc3\x9f" "erhalb des Bereichs" },
...
#define DE_STRING_COUNT \
    ((int)(sizeof(de_strings) / sizeof(de_strings[0])))
...
static const i18n_locale_table_t locale_tables[I18N_LOCALE_COUNT] = {
    ...
    [I18N_LOCALE_FR] = { fr_strings, FR_STRING_COUNT },
    [I18N_LOCALE_PT] = { pt_strings, PT_STRING_COUNT },
    [I18N_LOCALE_DE] = { de_strings, DE_STRING_COUNT }
