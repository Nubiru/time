...
static const br_known_pair_t KNOWN_PAIRS[] = {
    ...
    { CD_SYS_TAMIL,       CD_SYS_HINDU,      BR_CORR_STRUCTURAL, 0.95,
      "Tamil calendar is the South Indian regional Hindu variant" },
    { CD_SYS_TAMIL,       CD_SYS_ASTRONOMY,  BR_CORR_HARMONIC,   0.80,
      "Tamil 60-year Jovian cycle tracks Jupiter's orbital period" },
    { CD_SYS_TAMIL,       CD_SYS_BUDDHIST,   BR_CORR_APPROXIMATE, 0.40,
      "Shared Indian astronomical roots but diverged traditions" },
    { CD_SYS_MYANMAR,     CD_SYS_BUDDHIST,   BR_CORR_HARMONIC,   0.90,
      "Myanmar calendar exists to determine Buddhist holy days" },
    { CD_SYS_BUDDHIST,    CD_SYS_THAI,       BR_CORR_HARMONIC,   0.90,
      "Thai official calendar counts Buddhist Era from parinibbana" },
    { CD_SYS_KOREAN,      CD_SYS_JAPANESE,   BR_CORR_HARMONIC,   0.85,
      "Both adopted Chinese lunisolar calendar system" },
    { CD_SYS_ISLAMIC,     CD_SYS_PERSIAN,    BR_CORR_HARMONIC,   0.75,
      "Shared epoch (622 CE hijra) but solar vs lunar counting" },
    { CD_SYS_ISLAMIC,     CD_SYS_COPTIC,     BR_CORR_APPROXIMATE, 0.30,
      "Middle Eastern neighbors with opposite structures (lunar vs solar)" },
    { CD_SYS_ISLAMIC,     CD_SYS_HINDU,      BR_CORR_APPROXIMATE, 0.40,
      "South Asian coexistence under Mughal administrative parallel" },
    { CD_SYS_ASTROLOGY,   CD_SYS_HINDU,      BR_CORR_HARMONIC,   0.80,
      "Both divide the ecliptic (tropical vs sidereal)" },
    { CD_SYS_ASTROLOGY,   CD_SYS_PERSIAN,    BR_CORR_HARMONIC,   0.75,
      "Both trace to Babylonian celestial observation traditions" },
    { CD_SYS_ASTROLOGY,   CD_SYS_CHINESE,    BR_CORR_APPROXIMATE, 0.35,
      "Independent zodiac systems (ecliptic vs Jupiter yearly cycle)" },
    { CD_SYS_COPTIC,      CD_SYS_EGYPTIAN,   BR_CORR_STRUCTURAL, 0.95,
      "Coptic calendar is direct descendant of Egyptian civil calendar" },
    { CD_SYS_ZOROASTRIAN, CD_SYS_BAHAI,      BR_CORR_HARMONIC,   0.80,
      "Bahai Naw-Ruz inherited from Zoroastrian/Persian Nowruz" },
    { CD_SYS_ZOROASTRIAN, CD_SYS_EGYPTIAN,   BR_CORR_APPROXIMATE, 0.40,
      "Both ancient solar calendars with 12x30+5 epagomenal structure" },
    { CD_SYS_CELTIC,      CD_SYS_FRENCH,     BR_CORR_APPROXIMATE, 0.45,
      "European calendars: agricultural/spiritual vs rationalist" },
    { CD_SYS_HEBREW,      CD_SYS_BAHAI,      BR_CORR_APPROXIMATE, 0.40,
      "Abrahamic heritage but structurally different calendars" },
    { CD_SYS_ICHING,      CD_SYS_JAPANESE,   BR_CORR_HARMONIC,   0.80,
      "I Ching transmitted to Japan via Chinese cultural influence" },
    { CD_SYS_ICHING,      CD_SYS_KOREAN,     BR_CORR_HARMONIC,   0.85,
      "Korean flag displays four trigrams; central to Korean philosophy" },
    { CD_SYS_PERSIAN,     CD_SYS_EGYPTIAN,   BR_CORR_APPROXIMATE, 0.45,
