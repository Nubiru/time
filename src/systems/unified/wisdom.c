...
static const wisdom_t QUOTES[] = {
    ...
    /* --- Malcolm X --- The Awakener --- */

    { 199, "I have often reflected upon the new vistas that reading opened to me. I knew right there in prison that reading had changed forever the course of my life.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_CONSCIOUSNESS, WISDOM_TAG_POWER, WISDOM_TAG_TIME, 0,0,0 }, 3,
      SENSITIVITY_GENERAL },
    { 200, "I have less patience with someone who doesn't wear a watch than with anyone else, for this type is not time-conscious.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_TIME, WISDOM_TAG_CONSCIOUSNESS, 0,0,0,0 }, 2,
      SENSITIVITY_GENERAL },
    { 201, "My whole life had been a chronology of -- changes.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_CYCLES, WISDOM_TAG_TIME, WISDOM_TAG_POWER, 0,0,0 }, 3,
      SENSITIVITY_GENERAL },
    { 202, "It is only after the deepest darkness that the greatest joy can come; it is only after slavery and prison that the sweetest appreciation of freedom can come.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_CYCLES, WISDOM_TAG_CONSCIOUSNESS, WISDOM_TAG_POWER, 0,0,0 }, 3,
      SENSITIVITY_GENERAL },
    { 203, "In fact, up to then, I never had been so truly free in my life.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_CONSCIOUSNESS, WISDOM_TAG_POWER, 0,0,0,0 }, 2,
      SENSITIVITY_GENERAL },
    { 204, "Anything I do today, I regard as urgent. No man is given but so much time to accomplish whatever is his life's work.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_TIME, WISDOM_TAG_POWER, WISDOM_TAG_CONSCIOUSNESS, 0,0,0 }, 3,
      SENSITIVITY_GENERAL },
    { 205, "I'm for truth, no matter who tells it. I'm for justice, no matter who it is for or against. I'm a human being first and foremost, and as such I'm for whoever and whatever benefits humanity as a whole.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_UNITY, WISDOM_TAG_CONSCIOUSNESS, WISDOM_TAG_POWER, 0,0,0 }, 3,
      SENSITIVITY_GENERAL },
    { 206, "If white Americans could accept the Oneness of God, then perhaps, too, they could accept in reality the Oneness of Man -- and cease to measure, and hinder, and harm others in terms of their differences in color.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_UNITY, WISDOM_TAG_HARMONY, WISDOM_TAG_CONSCIOUSNESS, 0,0,0 }, 3,
      SENSITIVITY_RESPECTFUL },
    { 207, "Mankind's history has proved from one era to another that the true criterion of leadership is spiritual. Men are attracted by spirit. By power, men are forced. Love is engendered by spirit. By power, anxieties are created.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_POWER, WISDOM_TAG_CONSCIOUSNESS, WISDOM_TAG_CYCLES, 0,0,0 }, 3,
      SENSITIVITY_GENERAL },
    { 208, "All of our experiences fuse into our personality. Everything that ever happened to us is an ingredient.",
      "Malcolm X", "The Autobiography of Malcolm X", 1965, "Islamic",
      { WISDOM_TAG_TIME, WISDOM_TAG_CONSCIOUSNESS, WISDOM_TAG_CYCLES, 0,0,0 }, 3,
      SENSITIVITY_GENERAL },
};
