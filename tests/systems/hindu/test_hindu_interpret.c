 ...
 * Covers: hdi_tithi_data, hdi_interpret, hdi_tithi_count,
...
/* ===== hdi_tithi_data: specific tithis ===== */

void test_tithi_data_1_shukla_pratipada(void)
{
    hdi_tithi_t t = hdi_tithi_data(1);
...
{
    hdi_tithi_t t = hdi_tithi_data(3);
...
{
    hdi_tithi_t t = hdi_tithi_data(11);
...
{
    hdi_tithi_t t = hdi_tithi_data(15);
...
{
    hdi_tithi_t t = hdi_tithi_data(23);
...
{
    hdi_tithi_t t = hdi_tithi_data(26);
...
{
    hdi_tithi_t t = hdi_tithi_data(29);
...
{
    hdi_tithi_t t = hdi_tithi_data(30);
...
/* ===== hdi_tithi_data: invalid inputs ===== */

void test_tithi_data_invalid_zero(void)
{
    hdi_tithi_t t = hdi_tithi_data(0);
    TEST_ASSERT_EQUAL_INT(-1, t.number);
...
{
    hdi_tithi_t t = hdi_tithi_data(31);
    TEST_ASSERT_EQUAL_INT(-1, t.number);
    TEST_ASSERT_EQUAL_STRING("?", t.deity);
}
...
{
    for (int i = 1; i <= 30; i++) {
        hdi_tithi_t t = hdi_tithi_data(i);
...
{
    hdi_tithi_t shukla = hdi_tithi_data(11);
    hdi_tithi_t krishna = hdi_tithi_data(26);
...
{
    TEST_ASSERT_EQUAL_INT(30, hdi_tithi_count());
}

/* ===== hdi_interpret: glyph format ===== */

void test_interpret_glyph_shukla_1(void)
{
    hindu_interp_t r = hdi_interpret(1, NULL, NULL);
    TEST_ASSERT_EQUAL_STRING("S1", r.glyph);
}

void test_interpret_glyph_shukla_15(void)
{
    hindu_interp_t r = hdi_interpret(15, NULL, NULL);
...
void test_interpret_glyph_krishna_1(void)
{
    ...
    hindu_interp_t r = hdi_interpret(16, NULL, NULL);
...
void test_interpret_glyph_krishna_15(void)
{
    ...
    hindu_interp_t r = hdi_interpret(30, NULL, NULL);
    TEST_ASSERT_EQUAL_STRING("K15", r.glyph);
}

void test_interpret_glyph_shukla_5(void)
{
    hindu_interp_t r = hdi_interpret(5, NULL, NULL);
...
void test_interpret_glyph_krishna_12(void)
{
    ...
    hindu_interp_t r = hdi_interpret(27, NULL, NULL);
    TEST_ASSERT_EQUAL_STRING("K12", r.glyph);
}

/* ===== hdi_interpret: glance contains deity and quality ===== */

void test_interpret_glance_contains_deity(void)
{
    hindu_interp_t r = hdi_interpret(3, NULL, NULL);
...
{
    hindu_interp_t r = hdi_interpret(11, NULL, NULL);
    TEST_ASSERT_NOT_NULL(strstr(r.glance, "Fasting, devotion"));
}

/* ===== hdi_interpret: detail contains brief and activity ===== */
...
/* ===== hdi_interpret: with nakshatra and yoga ===== */
...
int main(void)
{
    ...
    /* hdi_interpret: with nakshatra/yoga */
