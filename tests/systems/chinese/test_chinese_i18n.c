...
{
    chinese_interp_t fr = ci_interpret_locale(0, 4, 0, 1,
                                              I18N_LOCALE_FR);
    /* FR falls back to EN content */
    TEST_ASSERT_EQUAL_STRING("Rat", fr.glyph);
    TEST_ASSERT_NOT_NULL(strstr(fr.glance, "Rat"));
    TEST_ASSERT_NOT_NULL(strstr(fr.glance, "Water"));
}
