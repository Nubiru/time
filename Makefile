...
SYSTEMS_SRC = src/systems/astronomy/orbit.c src/systems/astronomy/planets.c \
              ...
              src/systems/egyptian/egyptian.c \
              src/systems/thai/thai_calendar.c
...
test-egyptian: $(BUILD_DIR)
	$(CC) $(CFLAGS) tests/systems/egyptian/test_egyptian.c src/systems/egyptian/egyptian.c $(UNITY) -o $(BUILD_DIR)/test_egyptian $(LDFLAGS)
	./$(BUILD_DIR)/test_egyptian

test-thai-calendar: $(BUILD_DIR)
	$(CC) $(CFLAGS) tests/systems/thai/test_thai_calendar.c src/systems/thai/thai_calendar.c $(UNITY) -o $(BUILD_DIR)/test_thai_calendar $(LDFLAGS)
	./$(BUILD_DIR)/test_thai_calendar
